...
![项目概览](./doc/pic/user/首页.png)
![项目概览](./doc/pic/user/聚合AI-2.png)
![项目概览](./doc/pic/user/博客-搜索-ES.png)
![项目概览](./doc/pic/user/教程页.png)
![项目概览](./doc/pic/admin/仪表盘.png)
...
![项目概览](./doc/pic/user/忘记密码-邮箱验证.png)
...
![项目概览](./doc/pic/user/个人设置-修改资料.png)
...
![项目概览](./doc/pic/user/个人中心-帖子.png)

- **我的收藏**
    - 一键收藏感兴趣的内容（如帖子、教程等），快速保存，随时查看。
    - 集中管理收藏内容，简洁直观。

![项目概览](./doc/pic/user/个人中心-收藏.png)
...
![项目概览](./doc/pic/admin/用户管理-编辑.png)
...
![调整参数界面](./doc/pic/user/聚合AI-调整参数.png)
...
- **平台管理**
    ...
    - 管理员可查看、编辑或删除已配置平台，操作简单明了。
      ...
      ![AI平台管理界面](./doc/pic/admin/AI管理.png)
      ![编辑平台功能](./doc/pic/admin/AI管理-编辑平台.png)

- **模型管理**
    - 支持为每个平台添加多个模型，管理员可配置模型名称、类型（文本/图像等）、上下文数量、最大输出长度、费用信息等。
    - 提供模型编辑与删除功能，满足灵活管理需求。

  ![编辑模型功能](./doc/pic/admin/AI管理-编辑模型.png)
...
![文章详情1](./doc/pic/user/博客-文章详情1.png)  
![文章详情2](./doc/pic/user/博客-文章详情2.png)
...
![AI代写界面](./doc/pic/user/博客-AI代写.png)  
![AI代写结果](./doc/pic/user/博客-AI代写-结果.png)
...
![文章搜索](./doc/pic/user/博客-搜索-ES.png)
...
![教程详情页面](./doc/pic/user/教程详情-非会员.png)
![教程详情页面](./doc/pic/user/教程详情.png)
...
![支付页面展示1](./doc/pic/user/教程-支付宝1.png)
![支付页面展示2](./doc/pic/user/教程-支付宝2.png)
...
![个人中心订单](./doc/pic/user/个人中心-订单.png)
...
- **评论操作**
    - **回复评论**  
      管理员可直接对用户评论进行回复，促进用户互动。
        - 支持输入回复内容后实时发布回复。  
          ![回复评论功能](./doc/pic/admin/评论管理-回复评论.png)

    - **删除评论**  
      一键删除违规或无效评论，保持评论区整洁。

![评论管理界面](./doc/pic/admin/评论管理.png)
