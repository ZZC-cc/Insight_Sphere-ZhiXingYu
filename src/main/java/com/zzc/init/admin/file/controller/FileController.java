package com.zzc.init.admin.file.controller;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.io.FileUtil;
import com.zzc.init.admin.file.model.dto.UploadFileRequest;
import com.zzc.init.admin.user.model.entity.User;
import com.zzc.init.admin.user.model.enums.FileUploadBizEnum;
...
import com.zzc.init.constant.FileConstant;
import com.zzc.init.exception.BusinessException;
import com.zzc.init.manager.CosManager;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        String filepath = String.format("/%s/%s/%s", fileUploadBizEnum.getValue(), loginUser.getUser_id(), filename);
        File file = null;
        try {
            // 上传文件
